...
import { BotRepository } from './db/repository/BotRepository.js'
...
router.delete('/bots/:ckey', asyncHandler(async (req: Request, res: Response) => {
...
router.post('/bots', asyncHandler(async (req: Request, res: Response) => {
